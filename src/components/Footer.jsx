        ...
        <div className="lg:w-1/3">
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400">
              <img className="flex items-center justify-center w-12 h-12  rounded-full bg-violet-400" src="https://i.postimg.cc/76qhPMwn/emaar-logo-498-D3-F9-C34-seeklogo-com.png" alt="" />
            ...
            <span className="self-center text-2xl font-semibold">EMMAR</span>
          </a>
        </div>
